...
class ObstacleShape(ABC):
    MAX_DISTANCE_TO_BE_DEEMED_INTERSECTING = 0.001
    @abstractmethod
    ...
    def clip_points_with_plane(self, in_points, plane):
        ...
        if not True in point_in_plane_arr:
            return []
        ...
        self.remove_points_outside_of_angle_ranges(unclipped_points_plane, points, in_bounds_angle_ranges)
