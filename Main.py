...
waypoint_builder = OffsetWaypointBuilder(geo_points, obstacles, 5.0)#FixedAltLoiterWaypointBuilder(geo_points[0], 3, obstacles)#LoiterCylinderWaypointBuilder(geo_points[0], 3, obstacles, 5.0)#
