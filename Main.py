...
waypoint_builder = FixedAltLoiterWaypointBuilder(geo_points[0], 3, obstacles)#LoiterCylinderWaypointBuilder(geo_points[0], 3, obstacles, 5.0)#OffsetWaypointBuilder(geo_points, obstacles, 5.0)
waypoint_builder.save("/Users/phusisian/Desktop/DZYNE/Python/Generated Waypoints/", "waypoints9")
